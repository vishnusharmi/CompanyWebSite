...
const FinancialManagement = () => {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-4 md:mb-6">
          ...
          <div className="flex space-x-2 md:space-x-4">
            <button className="flex items-center cursor-pointer transition-all px-3 py-1 md:px-4 md:py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
              <Download className="h-4 w-4 md:h-5 md:w-5 mr-2" />
              <span className="text-sm md:text-base">Export Reports</span>
            </button>
            <button
              onClick={formHandle}
              className="flex items-center cursor-pointer transition-all px-3 py-1 md:px-4 md:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
            >
            ...
            <div className="bg-white rounded-lg p-4 md:p-6 shadow-lg w-full max-w-md mx-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end space-x-2 md:space-x-4 mt-4 md:mt-6">
                  ...
                  <button
                    type="submit"
                    className="px-3 py-1 md:px-4 md:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
                  >
                    Save
                  </button>
                </div>
      ...
      {/* Summary Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 max-w-screen lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
              ...
              <tr key={entry.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-2 md:px-6 md:py-4">
                  <div className="text-sm md:text-base text-gray-900">
                    ${entry.currentMonth.toLocaleString()}
                  </div>
                </td>
                <td className="px-4 py-2 md:px-6 md:py-4">
                  <div className="text-sm md:text-base text-gray-900">
                    ${entry.lastMonth.toLocaleString()}
                  </div>
                </td>
                <td className="px-4 py-2 md:px-6 md:py-4">
                  <div className="text-sm md:text-base text-gray-900">
                    ${entry.ytd.toLocaleString()}
                  </div>
                </td>
                <td className="px-4 py-2 md:px-6 md:py-4">
                  <span
