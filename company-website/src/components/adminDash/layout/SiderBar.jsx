...
const SideBar = () => {
  ...
  return (
    <>
      ...
      <nav className="bg-gray-900 text-white w-60 flex-shrink-0 bottom-0 z-50 flex flex-col relative">
        {/* Sidebar Header */}
      ...
      <div
        className={`md:hidden fixed inset-y-0 left-0 w-64 bg-gray-700 text-white transform transition-transform duration-300 ease-in-out z-50 ${isMenuOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
