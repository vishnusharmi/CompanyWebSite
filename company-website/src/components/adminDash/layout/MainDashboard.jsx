...
export default function Dashboard() {
  ...
  const pieData = [
    { name: "Projects Completed", value: 5000, color: "#7269EF" },
    ...
    <div>
      <div className="p-6 bg-gray-800 h-[calc(100vh)] overflow-y-auto  ">
        ...
        <div className=" rounded-2xl shadow-md p-6 flex items-center mt-20  bg-gray-50">
          ...
          />
          <div className="ml-6 ">
            <h2 className="text-xl text-black font-bold">Welcome</h2>
        ...
        <div className="bg-gray-800 text-white p-6 ">
          <div className="grid grid-cols-3 gap-6">
            {/* Left Card */}
            <div className="bg-gray-900 rounded-2xl p-6 shadow-lg pt-20 ">
              <h2 className="text-lg font-semibold text-gray-300">
                Total Revenue:
              </h2>
              <p className="text-3xl font-bold">$9,542.00</p>
              <p className="text-sm text-gray-400">
                From Jan 20, 2000 to July 2023
              </p>
              <div className="mt-4 flex items-center">
                <div className="h-14 w-full bg-green-500 rounded-lg"> </div>
              </div>
            ...
            {/* Bar Chart */}
            <div className="bg-gray-900  shadow-lg flex items-center justify-center rounded-2xl">
        ...
        <div className="grid grid-cols-4 gap-6 mt-6">
          {[
            ...
            <motion.div
              key={index}
              className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-center transition-transform transform hover:scale-105 duration-300"
